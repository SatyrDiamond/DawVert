...
if vstdata['datatype'] == 'raw':
	...
	version = vstdata['version']
	vstchunk = vstdata['data']

	print(fourid, version)
	...
	isobjfound_srt, v_struct = dataset.object_var_get('datadef_struct', 'plugin', str(fourid))

	print(isobjfound, v_datadef, str(fourid))
