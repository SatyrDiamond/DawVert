...
def rx_addtrack_inst(cvpj_l, idval, instdata):
...
def rx_addtrackpl(cvpj_l, idval, placements_data):
...
def rx_addtrack_data(cvpj_l, idval, trk_name, trk_color, trk_vol, trk_pan):
