		...
		if plugindata['name'] == 'ptvoice':
			...
			for unitdata in plugindata['data']['units']:
				...
				if ptv_wave_type == 'points': 
					...
					params_vital.replacewave(unit_num-1, params_vital_wavetable.resizewave(wavetable))
				...
				if ptv_wave_type == 'harm': 
					...
					params_vital.replacewave(unit_num-1, wavetable)
				...
				params_vital.setvalue('osc_'+str(unit_num)+'_level', ptv_vol*0.7)
