...
def convert(cvpj_l, pluginid, plugintype):
	...
	plugins.add_plug_param(cvpj_l, pluginid, "op1_scale", vrc_mod_kls, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_freqmul", vrc_mod_mul, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_env_attack", (vrc_mod_att*-1)+15, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_env_sustain", (vrc_mod_sus*-1)+15, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_perc_env", 0, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_env_decay", (vrc_mod_dec*-1)+15, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_env_release", vrc_mod_rel, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_level", (vrc_mod_out*-1)+63, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_tremolo", vrc_mod_trem, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_vibrato", vrc_mod_vib, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_ksr", vrc_mod_krs, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op1_waveform", vrc_mod_wave, 'int', "")

	plugins.add_plug_param(cvpj_l, pluginid, "op2_scale", vrc_car_kls, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_freqmul", vrc_car_mul, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_env_attack", (vrc_car_att*-1)+15, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_env_sustain", (vrc_car_sus*-1)+15, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_perc_env", 0, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_env_decay", (vrc_car_dec*-1)+15, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_env_release", vrc_car_rel, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_level", 63, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_tremolo", vrc_car_trem, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_vibrato", vrc_car_vib, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_ksr", vrc_car_krs, 'int', "")
	plugins.add_plug_param(cvpj_l, pluginid, "op2_waveform", vrc_car_wave, 'int', "")
	return True