...
def convert_inst(instdata):
	...
	if pluginname == 'native-lmms':
		...
		if lmmsnat_name == 'sid':
			...
			x_sid.set('program', '0')
			params_various_inst.socalabs_addparam(x_sid, "a1", lmmsnat_data['attack0'])
			params_various_inst.socalabs_addparam(x_sid, "a2", lmmsnat_data['attack1'])
			params_various_inst.socalabs_addparam(x_sid, "a3", lmmsnat_data['attack2'])
			params_various_inst.socalabs_addparam(x_sid, "cutoff", lmmsnat_data['filterFC'])
			params_various_inst.socalabs_addparam(x_sid, "d1", lmmsnat_data['decay0'])
			params_various_inst.socalabs_addparam(x_sid, "d2", lmmsnat_data['decay1'])
			params_various_inst.socalabs_addparam(x_sid, "d3", lmmsnat_data['decay2'])
			params_various_inst.socalabs_addparam(x_sid, "f1", lmmsnat_data['filtered0'])
			params_various_inst.socalabs_addparam(x_sid, "f2", lmmsnat_data['filtered1'])
			params_various_inst.socalabs_addparam(x_sid, "f3", lmmsnat_data['filtered2'])
			...
			if lmmsnat_data['filterMode'] == 0.0: params_various_inst.socalabs_addparam(x_sid, "highpass", 1.0)
			else: params_various_inst.socalabs_addparam(x_sid, "highpass", 0.0)
			if lmmsnat_data['filterMode'] == 1.0: params_various_inst.socalabs_addparam(x_sid, "bandpass", 1.0)
			else: params_various_inst.socalabs_addparam(x_sid, "bandpass", 0.0)
			if lmmsnat_data['filterMode'] == 2.0: params_various_inst.socalabs_addparam(x_sid, "lowpass", 1.0)
			else: params_various_inst.socalabs_addparam(x_sid, "lowpass", 0.0)
			params_various_inst.socalabs_addparam(x_sid, "output3", lmmsnat_data['voice3Off'])
			params_various_inst.socalabs_addparam(x_sid, "pw1", lmmsnat_data['pulsewidth0'])
			params_various_inst.socalabs_addparam(x_sid, "pw2", lmmsnat_data['pulsewidth1'])
			params_various_inst.socalabs_addparam(x_sid, "pw3", lmmsnat_data['pulsewidth2'])
			params_various_inst.socalabs_addparam(x_sid, "r1", lmmsnat_data['release0'])
			params_various_inst.socalabs_addparam(x_sid, "r2", lmmsnat_data['release1'])
			params_various_inst.socalabs_addparam(x_sid, "r3", lmmsnat_data['release2'])
			params_various_inst.socalabs_addparam(x_sid, "reso", lmmsnat_data['filterResonance'])
			params_various_inst.socalabs_addparam(x_sid, "ring1", lmmsnat_data['ringmod0'])
			params_various_inst.socalabs_addparam(x_sid, "ring2", lmmsnat_data['ringmod1'])
			params_various_inst.socalabs_addparam(x_sid, "ring3", lmmsnat_data['ringmod2'])
			params_various_inst.socalabs_addparam(x_sid, "s1", lmmsnat_data['sustain0'])
			params_various_inst.socalabs_addparam(x_sid, "s2", lmmsnat_data['sustain1'])
			params_various_inst.socalabs_addparam(x_sid, "s3", lmmsnat_data['sustain2'])
			params_various_inst.socalabs_addparam(x_sid, "sync1", lmmsnat_data['sync0'])
			params_various_inst.socalabs_addparam(x_sid, "sync2", lmmsnat_data['sync1'])
			params_various_inst.socalabs_addparam(x_sid, "sync3", lmmsnat_data['sync2'])
			params_various_inst.socalabs_addparam(x_sid, "tune1", lmmsnat_data['coarse0'])
			params_various_inst.socalabs_addparam(x_sid, "tune2", lmmsnat_data['coarse1'])
			params_various_inst.socalabs_addparam(x_sid, "tune3", lmmsnat_data['coarse2'])
			params_various_inst.socalabs_addparam(x_sid, "voices", 8.0)
			params_various_inst.socalabs_addparam(x_sid, "vol", lmmsnat_data['volume'])
			params_various_inst.socalabs_addparam(x_sid, "w1", sid_shape(lmmsnat_data['waveform0']))
			params_various_inst.socalabs_addparam(x_sid, "w2", sid_shape(lmmsnat_data['waveform1']))
			params_various_inst.socalabs_addparam(x_sid, "w3", sid_shape(lmmsnat_data['waveform2']))
