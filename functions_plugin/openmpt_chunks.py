...
def parse_start(filestream, convproj_obj):
    datadef = dv_datadef.datadef('./data_ddef/openmpt.ddef')
    dataset = dv_dataset.dataset('./data_dset/openmpt.dset')
    ...
    while True:
        ...
        if chunk_header == b'PNAM':
            ...
            add_plugin(convproj_obj, omptp_num, omptp_type, omptp_id, omptp_name, omptp_libname, omptp_chunkdata, datadef, dataset)
