...
class directwave_region:
	def __init__(self):
		...
		self.env_adsr = [0.0, 0.5, 0.9450000524520874, 0.25]
		self.env_alt = [[0.0, 0.5, 0.5, 0.25], [0.0, 0.5, 0.5, 0.25]]
		pass
	...
	def read(self, byr_stream):
		while byr_stream.remaining():
			...
			with byr_stream.isolate_size(chunksize, True) as bye_stream: 
				if VERBOSE: print('\t\t\t',chunktype, chunksize, end=': ')
				if chunktype == 500:
					self.key_root = bye_stream.uint8()
					self.key_min = bye_stream.uint8()
					self.key_max = bye_stream.uint8()
					self.vel_min = bye_stream.uint8()
					self.vel_max = bye_stream.uint8()
					self.mute = bye_stream.uint16()
					self.unk1 = bye_stream.uint16()
					self.gain = bye_stream.float()
					self.pan = bye_stream.float()
					if VERBOSE:
						#print(self.key_root, end=' ')
						#print(self.key_min, end=' ')
						#print(self.key_max, end=' ')
						#print(self.vel_min, end=' ')
						#print(self.vel_max, end=' ')
						#print(self.mute, end=' ')
						print(self.unk1, end=' ')
						#print(self.gain, end=' ')
						#print(self.pan, end=' ')
						print(bye_stream.float(), end=' ')
						print(bye_stream.uint16(), end=' ')
						print(bye_stream.uint16(), end=' ')

						print(bye_stream.rest(), end=' ')
						print()
					...
					self.pitch = bye_stream.float()
					self.pitch_semi = bye_stream.int8()
					self.pitch_fine = bye_stream.int8()
					self.ktrk = bye_stream.int8()
					if VERBOSE: 
						#print(self.pitch, end=' ')
						#print(self.pitch_semi, end=' ')
						#print(self.pitch_fine, end=' ')
						#print(self.ktrk, end=' ')
						print(bye_stream.int8(), end=' ')
						print()

				elif chunktype == 509:
					self.env_adsr = bye_stream.l_float(4)
					if VERBOSE: print(self.env_adsr)

				elif chunktype == 514:
					self.env_alt.append(bye_stream.l_float(4))
					if VERBOSE: print(self.env_adsr)
