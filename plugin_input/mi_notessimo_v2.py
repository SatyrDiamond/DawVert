...
notess_instruments =  {}
notess_instruments[12]  = [ 0,   25, [0.81, 0.59, 0.35], 'Acoustic Guitar']
notess_instruments[82]  = [ 0,   29, [0.87, 0.66, 0.07], 'Damant Spectrum Muted']
notess_instruments[79]  = [ 0,   26, [0.51, 0.80, 0.76], 'Fender Strat Guitar']
notess_instruments[78]  = [ 0,   26, [0.33, 0.42, 0.68], 'Strat Guitar']
notess_instruments[47]  = [ 0,   30, [0.05, 0.05, 0.05], 'Metal Guitar']
notess_instruments[64]  = [ 0,   27, [0.71, 0.38, 0.13], 'Guitar Electric']
notess_instruments[77]  = [ 0,   28, [0.23, 0.21, 0.21], 'Clean Electric Guitar']
notess_instruments[81]  = [ 0, None, [0.72, 0.09, 0.15], 'Damant Spectrum Harm']
notess_instruments[49]  = [ 0, None, [0.64, 0.24, 0.04], 'Bass Guitar']
notess_instruments[1]   = [ 0,   33, [0.64, 0.24, 0.04], 'Bass']
notess_instruments[39]  = [ 0,   34, [0.70, 0.29, 0.24], 'Bass #2']
notess_instruments[52]  = [ 0,   35, [0.70, 0.36, 0.12], 'Bass #3']
notess_instruments[59]  = [ 0,   36, [0.49, 0.11, 0.13], 'Bass #4']
notess_instruments[0]   = [ 0,   39, [0.18, 0.20, 0.21], 'Synth Bass']
notess_instruments[21]  = [ 0,   40, [0.18, 0.20, 0.21], 'Synth Bass #2']
notess_instruments[135] = [ 0,  105, [0.43, 0.13, 0.04], 'Sitar']
notess_instruments[136] = [ 0,   46, [0.91, 0.38, 0.16], 'Pizzicato']
notess_instruments[9]   = [ 0,   49, [0.89, 0.36, 0.16], 'Strings']
notess_instruments[36]  = [ 0,   50, [0.91, 0.38, 0.16], 'Strings #2']
notess_instruments[37]  = [ 0,   49, [0.71, 0.24, 0.09], 'Strings #3']
notess_instruments[31]  = [ 0,   51, [0.40, 0.53, 0.42], 'Synth Strings']
notess_instruments[80]  = [ 0, None, [0.33, 0.33, 0.33], 'Fret Noise']

notess_instruments[28]  = [ 0,    1, [0.00, 0.00, 0.00], 'Grand Piano']
notess_instruments[114] = [ 0,    5, [0.18, 0.18, 0.16], 'Rhodes']
notess_instruments[121] = [ 0,   56, [0.37, 0.18, 0.14], 'Orchestra Hit']
notess_instruments[13]  = [ 0, None, [0.00, 0.00, 0.00], 'Low Piano']
notess_instruments[115] = [ 0,    6, [0.68, 0.68, 0.68], 'Rhodes #2']
notess_instruments[11]  = [ 0, None, [0.56, 0.67, 0.25], 'Synth']
notess_instruments[116] = [ 0,    3, [0.79, 0.04, 0.09], 'Electric Piano']
notess_instruments[117] = [ 0,   19, [0.67, 0.49, 0.39], 'Rock Organ']
notess_instruments[17]  = [ 0,   84, [0.11, 0.11, 0.11], 'Synth #2']
notess_instruments[111] = [ 0,    8, [0.76, 0.76, 0.76], 'Clavinet']
notess_instruments[118] = [ 0,   20, [0.37, 0.18, 0.14], 'Church Organ']
notess_instruments[23]  = [ 0,   81, [0.33, 0.34, 0.39], 'Synthesizer']
notess_instruments[112] = [ 0, None, [0.56, 0.37, 0.31], 'Electric Clavinet']
notess_instruments[119] = [ 0,   18, [0.34, 0.31, 0.35], 'Percussive Organ']
notess_instruments[34]  = [ 0,   82, [0.33, 0.34, 0.39], 'Synthesizer #2']
notess_instruments[113] = [ 0,    7, [0.48, 0.31, 0.31], 'Harpsichord']
notess_instruments[120] = [ 0,   17, [0.11, 0.11, 0.11], 'Organ']
notess_instruments[50]  = [ 0,   83, [0.33, 0.34, 0.39], 'Synthesizer #3']
notess_instruments[110] = [ 0,   22, [0.45, 0.17, 0.20], 'Accordian']
notess_instruments[22]  = [ 0, None, [0.33, 0.34, 0.39], 'Triangle Wave']

notess_instruments[133] = [ 0, None, [0.07, 0.18, 0.26], 'Techno Bass']
...
notess_instruments[123] = [ 0,   10, [0.73, 0.65, 0.54], 'Glockenspiel']
notess_instruments[126] = [ 0,   14, [0.69, 0.58, 0.25], 'Xylophone']
notess_instruments[125] = [ 0,   12, [0.60, 0.61, 0.63], 'Vibraphone']
notess_instruments[124] = [ 0,   13, [0.89, 0.53, 0.02], 'Marimba']
notess_instruments[127] = [ 0,  109, [0.69, 0.36, 0.11], 'Kalimba']
notess_instruments[4]   = [ 0,  116, [0.76, 0.59, 0.43], 'Woodblock']
notess_instruments[129] = [ 0, None, [0.78, 0.75, 0.75], 'Clave']
notess_instruments[6]   = [ 0, None, [0.76, 0.76, 0.75], 'Tambourine']
notess_instruments[134] = [ 0,  115, [0.74, 0.22, 0.19], 'Steel Drum']
notess_instruments[130] = [ 0, None, [0.71, 0.46, 0.24], 'Conga']
notess_instruments[131] = [ 0, None, [0.98, 0.42, 0.15], 'Conga #2']
notess_instruments[132] = [ 0, None, [0.83, 0.65, 0.43], 'Conga #3']
notess_instruments[7]   = [ 0,  117, [0.82, 0.27, 0.11], 'Taiko Drum']
notess_instruments[10]  = [ 0,   48, [0.84, 0.70, 0.54], 'Timpani']
notess_instruments[128] = [ 0, None, [0.27, 0.29, 0.27], 'Cowbell']
notess_instruments[122] = [ 0,   15, [0.22, 0.20, 0.20], 'Tubular Bell']
notess_instruments[51]  = [ 0, None, [0.56, 0.59, 0.57], 'Blast']
notess_instruments[20]  = [ 0, None, [1.00, 0.82, 0.58], 'Hand Clap']

notess_instruments[8]   = [ 0,   57, [0.77, 0.63, 0.39], 'Trumpet']
notess_instruments[100] = [ 0,   57, [0.58, 0.51, 0.33], 'Trumpet #2']
notess_instruments[103] = [ 0,   73, [0.74, 0.67, 0.47], 'Piccolo Trumpet']
notess_instruments[99]  = [ 0, None, [0.75, 0.65, 0.47], 'Trumpet Muted']
notess_instruments[101] = [ 0, None, [0.60, 0.56, 0.45], 'Trumpet Hit']
notess_instruments[102] = [ 0, None, [0.69, 0.64, 0.53], 'Trumpet Section']
notess_instruments[97]  = [ 0,   58, [0.75, 0.65, 0.46], 'Trombone']
notess_instruments[95]  = [ 0,   59, [0.78, 0.65, 0.32], 'Tuba']
notess_instruments[98]  = [ 0,   61, [0.83, 0.68, 0.38], 'French Horn']
notess_instruments[58]  = [ 0,   63, [0.74, 0.62, 0.49], 'Synth Brass']

notess_instruments[83]  = [ 0,   65, [0.81, 0.73, 0.56], 'Soprano Sax']
notess_instruments[84]  = [ 0,   66, [0.95, 0.88, 0.63], 'Alto Sax']
notess_instruments[87]  = [ 0,   67, [0.67, 0.52, 0.31], 'Tenor Sax']
notess_instruments[88]  = [ 0,   68, [0.73, 0.59, 0.37], 'Baritone Sax']
notess_instruments[85]  = [ 0, None, [0.85, 0.72, 0.36], 'Sax Hit']
notess_instruments[86]  = [ 0, None, [0.79, 0.79, 0.57], 'Sax Sing']
notess_instruments[96]  = [ 0,   74, [0.79, 0.76, 0.73], 'Flute']
notess_instruments[89]  = [ 0, None, [0.62, 0.61, 0.63], 'Bass Clarinet']
notess_instruments[90]  = [ 0,   72, [0.47, 0.47, 0.45], 'Clarinet']
notess_instruments[91]  = [ 0,   70, [0.55, 0.54, 0.54], 'English Horn']
notess_instruments[92]  = [ 0,   69, [0.49, 0.43, 0.42], 'Oboe']
notess_instruments[93]  = [ 0,   80, [0.76, 0.36, 0.07], 'Ocarina']
notess_instruments[94]  = [ 0, None, [0.62, 0.50, 0.27], 'Wateki']

notess_instruments[104] = [ 0,   54, [0.98, 0.81, 0.86], 'Oohh']
notess_instruments[105] = [ 0,   53, [1.00, 0.67, 0.00], 'Aahh']
notess_instruments[106] = [ 0, None, [0.46, 0.46, 0.46], 'Choir']
notess_instruments[107] = [ 0, None, [0.80, 0.82, 0.85], 'Male Vox']
notess_instruments[108] = [ 0, None, [0.80, 0.82, 0.85], 'Female Vox']
notess_instruments[109] = [ 0,   55, [0.33, 0.67, 0.70], 'Synth Vox']
notess_instruments[16]  = [ 0, None, [0.35, 0.36, 0.40], 'Grinding']
notess_instruments[29]  = [ 0, None, [0.33, 0.67, 0.70], 'Cheers']
notess_instruments[33]  = [ 0, None, [0.44, 0.66, 0.85], 'Energy']
notess_instruments[35]  = [ 0, None, [0.22, 0.79, 0.98], 'Crystal']
notess_instruments[38]  = [ 0, None, [0.75, 0.67, 0.62], 'Fade In']
notess_instruments[41]  = [ 0, None, [0.99, 0.84, 0.32], 'Space']
notess_instruments[55]  = [ 0, None, [0.93, 0.93, 0.93], 'Nice']
