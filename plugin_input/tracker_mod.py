...
class input_mod(plugin_input.base):
    ...
    def detect(self, input_file):
        ...
        for _ in range(31):
            ...
            if 15 < sample_finetune:
                IsMod = 0
            sample_defaultvolume = int.from_bytes(bytestream.read(1), "big")
            if 64 < sample_defaultvolume:
                IsMod = 0
            bytestream.read(4)
        if IsMod == 1:
            return True
    ...
    def parse(self, input_file):
        ...
        for current_channelnum in range(number_of_channels):
            ...
            singletrack['muted'] = 0
            singletrack['placements'] = noteconv.timednotes2notelistplacement_parse_timednotes(timednotes)
        ...
        for sample in range(31):
            ...
            outputinst_track_plugindata['file'] = samplefolder + '/' + strsample.zfill(2) + '.wav'
