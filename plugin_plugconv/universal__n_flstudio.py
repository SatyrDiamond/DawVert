        ...
        if 'nonfree-plugins' not in extra_json:
            if plugintype[1].lower() == 'fruity parametric eq 2': 
                ...
                for bandnum in range(7):
                    ...
                    band_freq /= 65536
                    fl_eq_bands.append([20 * 1000**band_freq, band_gain/100, (pow(band_width/65536, 2))*5, band_type])
                ...
                for fl_eq_band in fl_eq_bands:
                    ...
                    plugins.add_eqband(cvpj_l, pluginid, band_enable, fl_eq_band[0], fl_eq_band[1], band_shape, fl_eq_band[2], None)
