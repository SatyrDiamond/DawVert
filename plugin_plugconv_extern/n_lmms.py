...
class plugconv(plugin_plugconv_extern.base):
    ...
    def convert(self, convproj_obj, plugin_obj, pluginid, dv_config, extplugtype, plugtransform):
        ...
        if plugin_obj.plugin_subtype == 'bitinvader':
        ...
        if plugin_obj.plugin_subtype == 'tripleoscillator' and 'vst2' in extplugtype:
            if params_os_vital.checksupport(extplugtype):
        ...
        if plugin_obj.plugin_subtype == 'papu' and 'vst2' in extplugtype:
            if plugin_vst2.check_exists('id', 1348563061):
                print("[plug-conv] LMMS to VST2: Freeboy > PAPU [SocaLabs]:",pluginid)
                ...
                return True
            else: errorprint.printerr('ext_notfound', ['VST2', 'PAPU [SocaLabs]'])

        if plugin_obj.plugin_subtype == 'sid' and 'vst2' in extplugtype:
            if plugin_vst2.check_exists('id', 1399415908):
                print("[plug-conv] LMMS to VST2: SID > SocaLabs's SID:",pluginid)
                plugtransform.transform('./data_plugts/lmms_vst2.pltr', 'vst2_sid', convproj_obj, plugin_obj, pluginid, dv_config)
                data_socalabs = params_os_socalabs.socalabs_data()
                data_socalabs.set_param("a1", plugtransform.get_storedval('a1'))
                data_socalabs.set_param("a2", plugtransform.get_storedval('a2'))
                data_socalabs.set_param("a3", plugtransform.get_storedval('a3'))
                data_socalabs.set_param("cutoff", plugtransform.get_storedval('cutoff'))
                data_socalabs.set_param("d1", plugtransform.get_storedval('d1'))
                data_socalabs.set_param("d2", plugtransform.get_storedval('d2'))
                data_socalabs.set_param("d3", plugtransform.get_storedval('d3'))
                data_socalabs.set_param("f1", int(plugtransform.get_storedval('f1')))
                data_socalabs.set_param("f2", int(plugtransform.get_storedval('f2')))
                data_socalabs.set_param("f3", int(plugtransform.get_storedval('f3')))
                data_socalabs.set_param("fine1", 0.0)
                data_socalabs.set_param("fine2", 0.0)
                ...
                data_socalabs.set_param("output3", plugtransform.get_storedval('output3'))
                data_socalabs.set_param("pw1", plugtransform.get_storedval('pw1'))
                data_socalabs.set_param("pw2", plugtransform.get_storedval('pw2'))
                data_socalabs.set_param("pw3", plugtransform.get_storedval('pw3'))
                data_socalabs.set_param("r1", plugtransform.get_storedval('r1'))
                data_socalabs.set_param("r2", plugtransform.get_storedval('r2'))
                data_socalabs.set_param("r3", plugtransform.get_storedval('r3'))
                data_socalabs.set_param("reso", plugtransform.get_storedval('reso'))
                data_socalabs.set_param("ring1", int(plugtransform.get_storedval('ring1')))
                data_socalabs.set_param("ring2", int(plugtransform.get_storedval('ring2')))
                data_socalabs.set_param("ring3", int(plugtransform.get_storedval('ring3')))
                data_socalabs.set_param("s1", plugtransform.get_storedval('s1'))
                data_socalabs.set_param("s2", plugtransform.get_storedval('s2'))
                data_socalabs.set_param("s3", plugtransform.get_storedval('s3'))
                data_socalabs.set_param("sync1", int(plugtransform.get_storedval('sync1')))
                data_socalabs.set_param("sync2", int(plugtransform.get_storedval('sync2')))
                data_socalabs.set_param("sync3", int(plugtransform.get_storedval('sync3')))
                data_socalabs.set_param("tune1", plugtransform.get_storedval('tune1'))
                data_socalabs.set_param("tune2", plugtransform.get_storedval('tune2'))
                data_socalabs.set_param("tune3", plugtransform.get_storedval('tune3'))
                data_socalabs.set_param("voices", 8.0)
                data_socalabs.set_param("vol", plugtransform.get_storedval('vol'))
                data_socalabs.set_param("w1", sid_shape(plugtransform.get_storedval('w1')))
                data_socalabs.set_param("w2", sid_shape(plugtransform.get_storedval('w2')))
                data_socalabs.set_param("w3", sid_shape(plugtransform.get_storedval('w3')))
                data_socalabs.to_cvpj_vst2(convproj_obj, plugin_obj, 1399415908)
                return True
            else: errorprint.printerr('ext_notfound', ['VST2', 'SID [SocaLabs]'])

        if plugin_obj.plugin_subtype == 'kicker' and 'vst2' in extplugtype:
            if plugin_vst2.check_exists('id', 934843292):
                print("[plug-conv] LMMS to VST2: Kicker > Kickmess:",pluginid)
                plugtransform.transform('./data_plugts/lmms_vst2.pltr', 'vst2_kicker', convproj_obj, plugin_obj, pluginid, dv_config)
                ...
                data_kickmess.set_param('pub', 'dist_start',     plugtransform.get_storedval('dist_start'))
                data_kickmess.set_param('pub', 'dist_end',       plugtransform.get_storedval('dist_end'))
                data_kickmess.set_param('pub', 'gain',           plugtransform.get_storedval('gain'))
                data_kickmess.set_param('pub', 'env_slope',      plugtransform.get_storedval('env_slope'))
                data_kickmess.set_param('pub', 'freq_slope',     plugtransform.get_storedval('freq_slope'))
                data_kickmess.set_param('pub', 'noise',          plugtransform.get_storedval('noise'))
                if plugtransform.get_storedval('startnote') == 1:   data_kickmess.set_param('pub', 'freq_note_start', 0.5)
                if plugtransform.get_storedval('endnote') == 1:     data_kickmess.set_param('pub', 'freq_note_end', 0.5)
        ...
        if plugin_obj.plugin_subtype == 'lb302':
            if params_os_vital.checksupport(extplugtype):
        ...
        if plugin_obj.plugin_subtype == 'zynaddsubfx' and 'vst2' in extplugtype:
            if plugin_vst2.check_exists('id', 1514230598):
                ...
                return True
            else: errorprint.printerr('ext_notfound', ['VST2', 'ZynAddSubFX'])

        if plugin_obj.plugin_subtype == 'reverbsc' and 'vst2' in extplugtype:
            if plugin_vst2.check_exists('id', 1279878002):
                print("[plug-conv] LMMS to VST2: ReverbSC > Castello Reverb:",pluginid)
                plugtransform.transform('./data_plugts/lmms_vst2.pltr', 'vst2_reverbsc', convproj_obj, plugin_obj, pluginid, dv_config)
                plugin_vst2.replace_data(convproj_obj, plugin_obj, 'id', 'any', 1279878002, 'chunk', 
                    data_nullbytegroup.make(
                        [{'ui_size': ''}, 
                        {'mix': '1', 'size': str(plugtransform.get_storedval('size')), 'brightness': str(plugtransform.get_storedval('color'))}]), 
                    None)
                return True
            else: errorprint.printerr('ext_notfound', ['VST2', 'Castello Reverb'])

        if plugin_obj.plugin_subtype == 'spectrumanalyzer' and 'vst2' in extplugtype:
            if plugin_vst2.check_exists('id', 1399874915):
                print("[plug-conv] LMMS to VST2: Spectrum Analyzer > SpectrumAnalyzer [SocaLabs]:",pluginid)
                data_socalabs = params_os_socalabs.socalabs_data()
                ...
                return True
            else: errorprint.printerr('ext_notfound', ['VST2', 'SpectrumAnalyzer [SocaLabs]'])

        if plugin_obj.plugin_subtype == 'waveshaper' and 'vst2' in extplugtype:
            if plugin_vst2.check_exists('id', 1935111024):
                ...
                return True
            else: errorprint.printerr('ext_notfound', ['VST2', 'Wolf Shaper'])
