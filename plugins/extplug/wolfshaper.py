...
class extplugin(plugins.base):
	...
	def getshortname(self): return 'wolfshaper'
	def getextpluginfo(self, plugconv_obj): 
		plugconv_obj.ext_formats = ['vst2']
		plugconv_obj.type = 'wolf-plugins'
		plugconv_obj.subtype = 'wolfshaper'
	...
	def check_plug(plugin_obj): 
		if plugin_obj.check_wildmatch('vst2', None):
			if plugin_obj.datavals.match('fourid', 1935111024): return 'vst2'
		return None
