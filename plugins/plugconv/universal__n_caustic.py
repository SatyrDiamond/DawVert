...
class plugconv(plugins.base):
	...
	def convert(self, convproj_obj, plugin_obj, pluginid, dv_config):
		...
		elif plugin_obj.type.subtype == 'master_eq':
		...
		elif plugin_obj.type.subtype == 'master_limiter':
		...
		elif plugin_obj.type.subtype == 'master_reverb':
		...
		elif plugin_obj.type.subtype == 'master_delay':
