...
class plugconv(plugins.base):
	...
	def getplugconvinfo(self, plugconv_obj): 
		...
		plugconv_obj.in_plugins = [['directx', None]]
	...
	def convert(self, convproj_obj, plugin_obj, pluginid, dv_config):
		...
		if plugin_obj.type.subtype == 'Gargle':
		...
		if plugin_obj.type.subtype == 'ParamEq':
		...
		if plugin_obj.type.subtype == 'I3DL2Reverb':
		...
		if plugin_obj.type.subtype == 'WavesReverb':
