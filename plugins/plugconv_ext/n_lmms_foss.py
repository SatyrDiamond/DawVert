...
class plugconv(plugins.base):
	...
	def getplugconvinfo(self, plugconv_ext_obj): 
		plugconv_ext_obj.in_plugin = ['native-lmms', None]
	...
	def convert(self, convproj_obj, plugin_obj, pluginid, dv_config, extplugtype):
		...
		if plugin_obj.type.subtype == 'papu':
			...
			if exttype:
				...
				plugin_obj.replace('socalabs', 'papu')
...
#
		...
		if plugin_obj.type.subtype == 'spectrumanalyzer':
			...
			if exttype:
				...
				plugin_obj.replace('socalabs', 'spectrumanalyzer')
		...
		if plugin_obj.type.subtype == 'stereoenhancer':
			...
			if exttype:
				...
				plugin_obj.replace('airwindows', 'Wider')
